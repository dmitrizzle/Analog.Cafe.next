...
define("./sw.js",['./workbox-1153c1ef'], function (workbox) { 'use strict';
  ...
  */
  ...
  workbox.precacheAndRoute([{
    ...
    "revision": "c186965a76ff3ffc6935c102c8fd2afe"
  }, {
    ...
    "revision": "7599434d394411aea4251ffde3516ec3"
  }], {
  ...
  workbox.registerRoute(/api.analog.cafe/, new workbox.NetworkFirst({
    "cacheName": "apiCache",
    plugins: [new workbox.CacheableResponsePlugin({
      statuses: [200]
    })]
  }), 'GET');
  workbox.registerRoute(/\.(?:woff|woff2|png|gif|jpg|jpeg|webp|svg)$/, new workbox.CacheFirst({
