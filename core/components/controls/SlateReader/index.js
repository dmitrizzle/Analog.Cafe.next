...
import { DEFAULT_EDITOR_STATE } from "../../../../constants/slate-document/default-states";
import {
  RULES_SERIALIZE,
  rulesSerializeWithProps,
} from "../../../../constants/slate-document/rules-serialize";
...
export const nodeFactory = props => {
  ...
  const elements = nodes
    .map(node => serializeNode(node, props))
    .filter(Boolean);
  return elements;
};
