      ...
      /> */}
        ...
        <ArticleSection>
          <p>
            ...
            footer of the email. Being a part of the email list is not the same
            as having an account with Analog.Cafe. Some emails are a part of the
          ...
          <p>
            ...
            <Email />. Analog.Cafe will comply with your request within a week.
            If you want your work to be removed from Analog.Cafe website, please
            send a separate request.
          </p>
          <p>
            If you are logged in to an account with Analog.Cafe, a token is
            stored on your device that verifies your identity to the server. It
            is not used to track your behaviour. Additionally (regardless of
            whether you have an account or not, logged in or not), Analog.Cafe
            may store textual data in a variety of forms on your device that
            lets you store your submissions in your browser and resume them even
            when you are offline, as well as to provide customized experiences.
            Analog.Cafe does not use that information to track and/or record
            your behaviour. Analog.Cafe can not see the content of your token or
            any of the stored data mentioned above. Analog.Cafe does not
            directly use cookie-tracking technology. An instance of Google
            Analytics and FullStory softwares <em>is</em> installed on
            Analog.Cafe, which employs cookies, however, they are not shared
            with any outside domain.
          </p>
          <p>
          ...
          <p>
            ...
            elsewhere. By using Analog.Cafe, you consent to this website&rsquo;s
            privacy policy. This policy might be updated without notice; all
            changes would be posted on this page. This policy was last modified
            on June 14, 2018.
          </p>
          ...
          <p>
            By creating and using Analog.Cafe account you also consent to making
            a public account with your infomation, accessible by search engines.
            This account can be automatically created for you from your social
            login data (your image, name, and short bio). You can easily edit
