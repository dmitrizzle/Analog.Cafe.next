    ...
    <Main>
      <ArticleWrapper>
        ...
        <ArticleSection>
          ...
          <p>
            Analog.Cafe is your platform to share your creative expressions and
            help others do the same.
          </p>
          <p>
            Once accepted, your work will go through a careful{" "}
            <strong>editorial process.</strong> Having a second set of
            discerning eyes on written work helps us keep the quality of content
            high and rejection rate low.
          </p>
          <p>
